(function () {
    ...
    window.Util = {
        ...
        /* @jscrambler disable controlFlowFlattening, stringConcealing, duplicateLiteralsRemoval */
        /* @jscrambler define controlFlowFlattening {features: []} as cff */
    ...
    window.Game = {
        run: function (options) {
            Game.loadImages(options.images, function (images) {
                ...
                var canvas = options.canvas, update = options.update, render = options.render, step = options.step, now = null, last = Util.timestamp(), dt = 0, gdt = 0;
                /* @jscrambler disable controlFlowFlattening, stringConcealing, duplicateLiteralsRemoval */
                /* @jscrambler define controlFlowFlattening {features: []} as cff */
                /* @jscrambler enable cff */
                function frame() {
    ...
    window.Render = {
        ...
        player: function (ctx, width, height, resolution, roadWidth, sprites, speedPercent, scale, destX, destY, steer, updown) {
            var bounce = 1.5 * Math.random() * speedPercent * resolution * Util.randomChoice([
                -1,
                1
            ]);
            var sprite;
